...
//WebUI.click(findTestObject('hsi_pl_login/Obiekty Ludwik/Obiekty dodatkowe do test_001/Tabela dokumenty do dekretacji wiersz 1'))
WebUI.click(findTestObject('hsi_pl_login/Obiekty Ludwik/Obiekty dodatkowe do test_001/button Dekretuj'))

WebUI.click(findTestObject('hsi_pl_login/Obiekty Ludwik/Obiekty dodatkowe do test_001/stanowisko docelowe'))
...
def szczegoly_metryka_statnia_czynnosc() {
    ...
    CustomKeywords.'help_pack.wait_for_text.Present'('Cofnięcie operacji typu: Dekretacja; ze Stanowiska:', 25)
