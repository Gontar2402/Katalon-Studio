...
OdrzucenieZastepstwaNaKoncieAnnaBorowska()

CustomKeywords.'help_pack.Wyloguj.wyloguj'()

CustomKeywords.'help_pack.Logowanie.zaloguj'('romuald.puzyrewski', 'gqNiyN/IiIvaUo8G1BKwoQ==')

SprawdzenieNaKoncieRomualdPuzyrewskiCzyPoprawnieOdrzuconoZastepstwo()
...
def OdrzucenieZastepstwaNaKoncieAnnaBorowska() {
    ...
    'Kliknij button Brak akceptacji'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'obi_zastepstwa_akceptacja_actions_brak_akceptacji\']/div']), 
        15)
    ...
    Akceptacja = WebUI.getText(findTestObject('tabela', [('xpath') : '//table[@id=\'tblZaakceptowaneInstancjeakceptacjiIndexGrid\']/tbody/tr/td[6]']))

    assert Akceptacja == 'Nie'
}
