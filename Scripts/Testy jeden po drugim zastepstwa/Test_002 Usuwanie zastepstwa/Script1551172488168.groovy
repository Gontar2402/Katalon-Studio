...
def UsuniecieZastepstwa() {
    WebDriver driver3 = DriverFactory.getWebDriver()

    'To locate table'
    WebElement Table3 = driver3.findElement(By.xpath('//table[@id=\'tblZastepstwaIndexGrid\']/tbody'))

    'To locate rows of table it will Capture all the rows available in the table'
    List<WebElement> rows_table3 = Table3.findElements(By.tagName('tr'))

    List<WebElement> columns_table3 = Table3.findElements(By.tagName('td'))

    'To calculate no of rows In table'
    int LiczbaWierszyPrzedUsunieciemZastepstwa = rows_table3.size()
    ...
    'To locate table'
    WebElement Table4 = driver4.findElement(By.xpath('//table[@id=\'tblZastepstwaIndexGrid\']/tbody'))

    'To locate rows of table it will Capture all the rows available in the table'
    List<WebElement> rows_table4 = Table4.findElements(By.tagName('tr'))

    'To calculate no of rows In table'
    int LiczbaWierszyPoUsunieciuZastepstwa = rows_table4.size()

    assert LiczbaWierszyPrzedUsunieciemZastepstwa != LiczbaWierszyPoUsunieciuZastepstwa
}
