...
CustomKeywords.'help_pack.wait_for_text.Present'('Dokumenty wewnętrzne', 15)
...
CustomKeywords.'help_pack.Sortowanie_tabeli.Sortowanie'(1, 2, 3)

CustomKeywords.'help_pack.Sortowanie_tabeli.Sortowanie'(4, 10, 3)
