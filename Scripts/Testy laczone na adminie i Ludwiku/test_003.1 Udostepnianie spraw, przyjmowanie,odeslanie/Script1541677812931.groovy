...
CustomKeywords.'help_pack.wait_for_text.Present'('Pozycje od', 10)
...
CustomKeywords.'help_pack.Set_text_and_press_enter.set_text'(findTestObject('hsi_pl_login/Obiekty Ludwik/Obiekty dodatkowe do test_003/do pola Uwagi do udostepnienia'), 
    GlobalVariable.losowa_nazwa + 'test katalon przyjmij')
...
CustomKeywords.'help_pack.wait_for_text.not_Present'(GlobalVariable.losowa_nazwa + 'test katalon przyjmij', 15)

CustomKeywords.'help_pack.Set_text_and_press_enter.set_text'(findTestObject('hsi_pl_login/Obiekty Ludwik/Obiekty dodatkowe do test_003/do pola Uwagi do udostepnienia'), 
    GlobalVariable.losowa_nazwa + 'test katalon odeslij')
...
CustomKeywords.'help_pack.wait_for_text.not_Present'(GlobalVariable.losowa_nazwa + 'test katalon odeslij', 15)
