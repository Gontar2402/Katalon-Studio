...
EdytowanieRodzajuPsma()
SprawdzanieCzyZmienilaSieNazwaRodzajuPoEdyjci()
def NowyRodzajPismaWychodzacego() {
    ...
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button text', [('text') : LosowaNazwaRodzajuPisma]), 
        15)
}
...
def SprawdzenieCzyRodzajPismaZostalDodany() {
    ...
    ZnakSprawyDoKtorejDodajemyDokymentWychodzacy = WebUI.getText(findTestObject('tabela', [('xpath') : '//td[2]']))
...
def EdytowanieRodzajuPsma() {
    ...
    'button Edytuj rodzaj pisma'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//td[@id=\'edit_admin_dic_rodzaj_pisma_table\']/div/span']), 
        15)

    LosowaNazwaRodzajuPismaEdycja = org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(8)

    'Wpisujemy losową nazwę pisma'
    WebUI.setText(findTestObject('pole tekstowe', [('xpath') : '//input[@id=\'obi_rodzaj_pisma[nazwa]\']']), LosowaNazwaRodzajuPismaEdycja)

    'button Zapisz'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//a[contains(text(),\'Zapisz\')]']), 
        15)

    'Wyszukujemy edytowany rodzaj pisma'
    CustomKeywords.'help_pack.Set_text_and_press_enter.na_adminie'(findTestObject('pole tekstowe', [('xpath') : '//input[@id=\'gs_obi_rodzaj_pisma[nazwa]\']']), 
        LosowaNazwaRodzajuPismaEdycja)

    'sprawdzamy czy rodzaj pisma został edytowany'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button text', [('text') : LosowaNazwaRodzajuPismaEdycja]), 
        15)
}

def SprawdzanieCzyZmienilaSieNazwaRodzajuPoEdyjci() {
    CustomKeywords.'help_pack.Wyloguj.wyloguj'()
    ...
    CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz.set_text'(findTestObject('pole tekstowe', [('xpath') : '//input[@name=\'znak_sprawy\']']), 
        ZnakSprawyDoKtorejDodajemyDokymentWychodzacy)
	'button Rozwiń sprawe'
	CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//table[@id=\'tblSprawyBiezace\']/tbody/tr/td/span']),
		15)
	...
	CustomKeywords.'help_pack.wait_for_text.Present'(LosowaNazwaRodzajuPismaEdycja, 10)
}
