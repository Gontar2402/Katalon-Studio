...
DodaniePrzychodzacegoPunktuKacelaryjnego()
UsunieciePrzychodzacegoPunktuKacelaryjnego()
ProbaUsunieciaPrzychodzacegoPunktuKancelaryjnegoKtoregoNieMoznaUsunac()
SprawdzanieCzyUsunietoPrzychodzacyPunktKancelaryjny()


def ProbaUsunieciaPrzychodzacegoPunktuKancelaryjnegoKtoregoNieMoznaUsunac() {
    ...
    CustomKeywords.'help_pack.Set_text_and_press_enter.na_adminie'(findTestObject('pole tekstowe', [('xpath') : '//input[@id=\'gs_punkt[nazwa]\']']), 
        'Punkt kancelaryjny DOKUS')

    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button text', [('text') : 'Punkt kancelaryjny DOKUS']), 
        15)

    'button Usuń wiersz'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//td[@id=\'del_admin_punkty_kancelaryjne_przych_table\']/div/span']), 
        15)
    ...
    CustomKeywords.'help_pack.wait_for_text.Present'('Nie można usunąć podanego punktu kancelaryjnego, gdyż został on już wykorzystany', 
        10)
}

def UsunieciePrzychodzacegoPunktuKacelaryjnego() {
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('admin_php/Menu glowne belka gorna/przyciski glowne na belce gornej/Punkty kancelaryjne'), 
        15)
	...
	CustomKeywords.'help_pack.Set_text_and_press_enter.na_adminie'(findTestObject('pole tekstowe', [('xpath') : '//input[@id=\'gs_punkt[nazwa]\']']),
		losowa_nazwa_PK)
	CustomKeywords.'help_pack.wait_for_text.not_Present'(losowa_nazwa_PK, 15)
}

def DodaniePrzychodzacegoPunktuKacelaryjnego() {
...
def SprawdzanieCzyUsunietoPrzychodzacyPunktKancelaryjny() {
