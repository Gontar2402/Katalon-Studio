...
UsuwanieOsobyZeStanowiskaTest_1()
...
SprawdzanieCzyUzytkownikNieWidziUsunietegoPotencjalengoZastepcy()

def UsuwanieOsobyZeStanowiskaTest_1 (){ 
...
def SprawdzanieCzyUzytkownikNieWidziUsunietegoPotencjalengoZastepcy() {
    ...
    CustomKeywords.'help_pack.wait_for_text.not_Present'('Bogulak', 15)

    CustomKeywords.'help_pack.wait_for_text.not_Present'('Alchimowicz', 15)
}
...
def NadanieUprawnien() {
    ...
    CzyZaznaczony = WebUI.verifyElementChecked(findTestObject('button', [('xpath') : '//tr[@id=\'-1\']/td[3]/input']), 15, 
