...
CzyNieZaznaczony = WebUI.verifyElementNotChecked(findTestObject('pole tekstowe', [('xpath') : '//td[9]/input']), 4, FailureHandling.OPTIONAL)
...
WebUI.comment('Sprawdzamy czy osoba dodała się w tabeli Stanowiska grupy')
...
WebUI.comment('Sprawdzamy czy osoba dodała się w tabeli Grupy stanowiska')
...
'Sprawdzamy w tabeli czy dodała się grupa'
...
'Wiersz pierwszy w tabeli'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button text', [('text') : 'Administrator']), 15)

'button Zmień (Edycja grup stanowiska)'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//td[@id=\'admin_grupy_stanowiska_ptable_left\']/table/tbody/tr/td[4]/div/span']), 
    15)

'odznaczamy pole input'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//tr[@id=\'1\']/td[2]/input']), 
    15)
