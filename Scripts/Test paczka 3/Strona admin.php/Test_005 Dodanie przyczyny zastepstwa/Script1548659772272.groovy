...
Dodanie_nowego_zastepstwa_i_sprawdzenie_czy_sie_dodalo()

def Dodanie_nowego_zastepstwa_i_sprawdzenie_czy_sie_dodalo() {
    ...
    CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz.set_text'(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'nazwa\'])[2]']), 
        GlobalVariable.losowa_nazwa)
    ...
    'wyszukanie przyczyny'
    CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz.set_text'(findTestObject('pole tekstowe', [('xpath') : '//input[@name=\'idprzyczyna\']']), 
        GlobalVariable.losowa_nazwa)
    ...
    assert przyczyna == GlobalVariable.losowa_nazwa
}
