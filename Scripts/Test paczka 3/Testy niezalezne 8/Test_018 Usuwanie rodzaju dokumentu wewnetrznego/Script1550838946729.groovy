...
'Wyszukaj i klinij rodzaj pisam którego nie można usunąć ze względu na powiązania'
CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz.set_text'(findTestObject('pole tekstowe', [('xpath') : '//input[@name=\'nazwa\']']), 
    'pismo dotyczące nieprawidłowości w imporcie')

'Kliknij button Usuń'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'obi_dokwew_kategoria_menu_actions_usun_button\']/div']), 
    15)
