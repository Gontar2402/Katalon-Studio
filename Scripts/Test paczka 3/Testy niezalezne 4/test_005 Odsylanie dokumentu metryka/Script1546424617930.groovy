...
'Stanowisko docelowe Ludwik Bartoszewicz'
...
'button Odeślij'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//li[3]/div[3]/div']), 15)
...
def tworzenie_dokumentu() {
    GlobalVariable.losowa_nazwa = ('odeslanie dokumentu ' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(
        8))
