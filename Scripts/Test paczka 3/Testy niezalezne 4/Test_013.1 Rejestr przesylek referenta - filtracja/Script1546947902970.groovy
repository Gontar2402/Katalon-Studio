...
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('hsi_pl_login/Menu glowne belka gorna/podmenu Kancelaria/Przesylki do wysania'), 
    15)

'poczekaj aż załaduje się tabela'
CustomKeywords.'help_pack.wait_for_text.Present'('Przesyłki do wysłania', 15)
...
CustomKeywords.'help_pack.Filtruj.pobieranie_danych_do_filtrowania_oraz_filtrowanie'(4, 3)
...
CustomKeywords.'help_pack.Filtruj.pobieranie_danych_do_filtrowania_oraz_filtrowanie'(18, 3)
