...
sprawdzanie_zakladki_pliki()

def sprawdzanie_zakladki_pliki() {
    'zakładka pliki'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'fullInfoDokumentWychodzacy\']/ul/li[5]/a']), 
        15)
