...
def sprawdzanie_zakladki_dekretacja() {
    'zakładka Dekretacja'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'full_info_dokument\']/ul/li[2]/a']), 
        15)
    ...
    CustomKeywords.'help_pack.wait_for_text.Present'('Dekretacja', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Procedowanie', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Rodzaj operacji', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Tryb dekretacji', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Wykonujący operację', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Polecenie', 15)
