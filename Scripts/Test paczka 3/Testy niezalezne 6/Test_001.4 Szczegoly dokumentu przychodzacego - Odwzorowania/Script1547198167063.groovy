...
sprawdzanie_zakladki_odwzorowania()

def sprawdzanie_zakladki_odwzorowania() {
    'zakładka Odwzorowania'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'full_info_dokument\']/ul/li[7]/a']), 
        15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Akcje', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Założył', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Źródło', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Kategoria', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Rozmiar', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Nazwa pliku', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Data wgrania', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Kod kreskowy', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Powiązane odwzorowania', 15)
