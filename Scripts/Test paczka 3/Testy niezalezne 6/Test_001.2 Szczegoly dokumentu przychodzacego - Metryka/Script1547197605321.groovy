...
def sprawdzanie_zakladki_metryka() {
    'zakładka Metryka'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'full_info_dokument\']/ul/li[10]/a']), 
        15)
    ...
    CustomKeywords.'help_pack.wait_for_text.Present'('Wydruk', 15)
