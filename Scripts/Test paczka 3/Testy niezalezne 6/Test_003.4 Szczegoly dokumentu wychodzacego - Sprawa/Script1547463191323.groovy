...
sprawdzanie_zakladki_sprawa()

def sprawdzanie_zakladki_sprawa() {
    'zakładka sprawa'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'fullInfoDokumentWychodzacy\']/ul/li[2]/a']), 
        15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Znak sprawy', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Tytuł sprawy', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Hasło JRWA', 15)
    ...
    CustomKeywords.'help_pack.wait_for_text.Present'('Etykieta', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Data otrzymania decyzji', 15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Pilność', 15)
	...
	CustomKeywords.'help_pack.wait_for_text.Present'('Dokumentacja elektroniczna', 15)
