...
tworzenie_nowego_sposobu_wysylki()

CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz_z_polem.set_text'(GlobalVariable.zmienna_pomocna, 
    2)

CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz_z_polem.set_text'(GlobalVariable.zmienna_pomocna, 2)

def tworzenie_nowego_sposobu_wysylki() {
