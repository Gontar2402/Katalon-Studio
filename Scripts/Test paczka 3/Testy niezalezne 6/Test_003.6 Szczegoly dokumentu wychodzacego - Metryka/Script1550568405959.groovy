...
sprawdzanie_zakladki_metryka()

def sprawdzanie_zakladki_metryka() {
    'zakładka Metryka'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//a[contains(text(),\'Metryka\')]']), 
        15)

    CustomKeywords.'help_pack.wait_for_text.Present'('Metryka dokumentu wychodzącego', 15)
