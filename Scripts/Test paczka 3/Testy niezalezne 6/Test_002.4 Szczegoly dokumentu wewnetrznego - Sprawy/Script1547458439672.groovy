...
def sprawdzanie_zakladki_sprawy() {
    'zakładka sprawy'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'fullInfoDokumentWewnetrzny\']/ul/li[2]/a']), 
        15)



    CustomKeywords.'help_pack.wait_for_text.Present'('Sprawy dokumentu wewnętrznego', 15)
