...
'Ulice'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//ul[6]/li/div']), 15)

'Ulice Dodaj'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//ul[6]/li[2]/div']), 15)

CustomKeywords.'help_pack.wait_for_text.not_Present'('Proszę czekać...', 15)

losowa_nazwa_ulicy = org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(8)

'Pole Nazwa ulicy'
WebUI.setText(findTestObject('pole tekstowe', [('xpath') : '//tr[2]/td/input']), losowa_nazwa_ulicy)

'Utwórz i zamknij'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//input[3]']), 15)

CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz_z_polem.set_text'(losowa_nazwa_ulicy, 2)
