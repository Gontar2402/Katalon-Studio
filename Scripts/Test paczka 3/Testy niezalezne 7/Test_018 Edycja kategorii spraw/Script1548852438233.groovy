...
'button Edycja'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[@id=\'obi_sprawy_edytuj_kategorie_button\']/div']), 
    15)

CustomKeywords.'help_pack.wait_for_text.Present'('Kategorie spraw - modyfikacja', 15)

kategoria_sprawy_edycja = org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(8)

'wpisz losową nazwe do pola nazwa'
WebUI.setText(findTestObject('pole tekstowe', [('xpath') : '//input[@id=\'obi_kategorie_spraw_nazwa\']']), kategoria_sprawy_edycja)

'button Zapisz'
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//input[@id=\'btnKategoriasprawySaveChanges\']']), 
    15)

CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz_z_polem.set_text'(kategoria_sprawy_edycja, 2)
