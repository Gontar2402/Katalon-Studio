...
TestowanieWyszukiwanaiZaawansowanegoGrupowanie()

def TestowanieWyszukiwanaiZaawansowanegoGrupowanie() {
    ...
    'operator ,,Grupowanie"'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[2]/div/div/div[3]']), 
        15)
    ...
    'przenosimy na formularz grupowanie'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div/div[2]/div[3]/div']), 
        15)
    ...
    'wpisujemy wartosc pobrana z tabeli'
    WebUI.setText(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[2]']), "nie ma takiego tytulu")
