...
TestowanieWyszukiwanaiZaawansowanegoOperatorITekstZawiera()

def TestowanieWyszukiwanaiZaawansowanegoOperatorITekstZawiera() {
    ...
    'operator ,,I"'
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//div[11]/div[2]/div/div/div']), 
        15)
    ...
    WebUI.selectOptionByLabel(findTestObject('Wybierz opcje', [('xpath') : '(//select[@name=\'rodzaj-warunku\'])[2]']), 
        'zawiera', false)

    'wpisujemy wartosc pobrana z tabeli'
    WebUI.setText(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[2]']), Tytul)

    WebUI.sendKeys(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[2]']), Keys.chord(
            Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE))

    WebUI.sendKeys(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[2]']), '*')

    WebUI.selectOptionByLabel(findTestObject('Wybierz opcje', [('xpath') : '(//select[@name=\'rodzaj-warunku\'])[3]']), 
        'zawiera', false)

    'wpisujemy wartosc pobrana z tabeli'
    WebUI.setText(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[3]']), NadawcaImie)

    WebUI.sendKeys(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[3]']), Keys.chord(
            Keys.BACK_SPACE, Keys.BACK_SPACE))

    WebUI.sendKeys(findTestObject('pole tekstowe', [('xpath') : '(//input[@name=\'wartosc-warunku\'])[3]']), '*')
