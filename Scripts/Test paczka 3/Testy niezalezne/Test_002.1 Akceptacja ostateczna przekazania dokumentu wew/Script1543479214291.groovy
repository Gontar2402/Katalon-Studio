...
CustomKeywords.'help_pack.metryka_sprawdz_statna_czynnosc.szczegoly_metryka_ostatnia_czynnosc1'('Przekazanie dokumentu; do: Administrator EZD (Adam Naczelny); autor: Adam Naczelny', 
...
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('hsi_pl_login/Obiekty powtarzalne/button Przyjmij uniwersalny'), 
    15)
...
CustomKeywords.'help_pack.metryka_sprawdz_statna_czynnosc.szczegoly_metryka_ostatnia_czynnosc1'('Przyjęcie dekretacji dokumentu wewnętrznego; tryb: Przekazanie;', 
    'Administrator EZD (Adam Naczelny)')
