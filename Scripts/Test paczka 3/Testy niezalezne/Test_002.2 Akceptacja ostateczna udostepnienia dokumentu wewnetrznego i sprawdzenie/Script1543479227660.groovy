...
CustomKeywords.'help_pack.metryka_sprawdz_statna_czynnosc.szczegoly_metryka_ostatnia_czynnosc1'('Przekazanie dokumentu; do: Wojewódzki Lekarz Weterynarii (Ludwik Bartoszewicz); autor: Adam Naczelny', 
