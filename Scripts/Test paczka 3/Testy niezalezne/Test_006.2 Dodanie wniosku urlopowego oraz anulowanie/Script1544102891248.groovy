...
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//li[8]/ul/li[2]/div[3]/div']), 
    15)
...
CustomKeywords.'help_pack.wait_for_text.Present'('Odrzucony', 15)
