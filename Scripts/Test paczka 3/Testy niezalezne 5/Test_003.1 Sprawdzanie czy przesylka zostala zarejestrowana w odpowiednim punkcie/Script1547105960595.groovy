...
'zmiana punktu kancelaryjnego'
WebUI.selectOptionByValue(findTestObject('Wybierz opcje', [('xpath') : '//select[@id=\'punktkancelaryjny\']']), '3', false)
...
CustomKeywords.'help_pack.wait_for_text.Present'('Twoje stanowisko przypisane jest do punktu kancelaryjnego ESOD.', 15)

def rejestracja_nowej_przesylki() {
    ...
    GlobalVariable.losowa_nazwa = ('Sprawdzanie PK ' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(8))
