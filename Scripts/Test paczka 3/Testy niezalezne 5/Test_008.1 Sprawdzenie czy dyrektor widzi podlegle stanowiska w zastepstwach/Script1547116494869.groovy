...
'Sprawdzanie czy tabela się załadowała'
...
'wyszukiwanie w tabeli osób po nazwisku'
CustomKeywords.'help_pack.Wyszukaj_w_tabeli_i_kliknij_wyszukany_wiersz_z_polem.set_text'('Zuchowicz', 5)
