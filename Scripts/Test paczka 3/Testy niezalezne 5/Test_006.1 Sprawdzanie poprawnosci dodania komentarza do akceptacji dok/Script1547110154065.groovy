...
GlobalVariable.losowa_nazwa = (org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(8) + 'komentarz')
...
CustomKeywords.'help_pack.metryka_sprawdz_statna_czynnosc.szczegoly_metryka_ostatnia_czynnosc1'(('Komentarz do akceptacji; ' + 
    losowy_komentarz) + ';', 'Administrator EZD (Adam Naczelny)')

'Pobieranie komentarza do akceptacji'
komentarz_do_akceptacji = WebUI.getText(findTestObject('tabela', [('xpath') : '//td[10]']))

assert komentarz_do_akceptacji == losowy_komentarz
