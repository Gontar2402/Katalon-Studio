...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy na koncie Ludwik\\test_001.1 Dekretacja dokumentu z stanowiska zastepowanego\\20181108_133917\\execution.properties')
...
WebUI.click(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/button Dekretuj'))

WebUI.click(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/stanowisko docelowe'))

WebUI.click(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/button OK'))

WebUI.waitForElementVisible(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/button Zadekretowane '), 
    25)

WebUI.click(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/button Zadekretowane '))

WebUI.click(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/button Przychodzce'))

CustomKeywords.'help_pack.Set_text_and_press_enter.set_text'(findTestObject('Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_001/do pola tytul'), 
    'test48511')
