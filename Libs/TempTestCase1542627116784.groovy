...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy laczone na adminie i Ludwiku\\test_003.1 Udostepnianie spraw, przyjmowanie,odeslanie\\20181119_123156\\execution.properties')
...
WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe na koncie Ludwik/Obiekty dodatkowe do test_003/stanowisko docelowe'))
...
CustomKeywords.'help_pack.wait_for_text.not_Present'('test katalon przyjmij', 10)
...
CustomKeywords.'help_pack.wait_for_text.not_Present'('test katalon odeslij', 10)

''', 'Test Cases/Testy laczone na adminie i Ludwiku/test_003.1 Udostepnianie spraw, przyjmowanie,odeslanie', new TestCaseBinding('Test Cases/Testy laczone na adminie i Ludwiku/test_003.1 Udostepnianie spraw, przyjmowanie,odeslanie',[:]), FailureHandling.STOP_ON_FAILURE , false)
