...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\test_014 Dodaj, edytuj, usun pismo wychodzace\\20181113_080420\\execution.properties')
...
not_run: CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/obiekty dodatkowe do test_003/wyszukane pismo katalon'), 
    5)

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/obiekty dodatkowe do test_003/button edytuj wybrany wiersz'))
...
not_run: CustomKeywords.'help_pack.wait_for_text.Present'('katalonTestNowePismoEdycja', 5)
...
''', 'Test Cases/test_014 Dodaj, edytuj, usun pismo wychodzace', new TestCaseBinding('Test Cases/test_014 Dodaj, edytuj, usun pismo wychodzace',[:]), FailureHandling.STOP_ON_FAILURE , false)
