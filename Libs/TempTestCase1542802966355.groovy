...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy laczone na adminie i Ludwiku\\test_006 Sprawdzenie transferu dokumentow i spraw po zwolnieniu pracownika\\20181121_132246\\execution.properties')
...
not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Menu glowne belka gorna/podmenu Stanowiska/Awans stanowiska/rozwin menu grupa praw w awans stanowiska'))

not_run: CustomKeywords.'help_pack.Set_text_and_press_enter.na_adminie'(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Menu glowne belka gorna/podmenu Stanowiska/Awans stanowiska/pole grupa praw w Awans'), 
    'Administrator')

not_run: WebUI.setText(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Menu glowne belka gorna/podmenu Stanowiska/Awans stanowiska/pole nazwa stanowiska w awans pracownika'), 
    losowa_nazwa)

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Menu glowne belka gorna/podmenu Stanowiska/button DALEJ'))
