...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy laczone na adminie i Ludwiku\\test_002 Udostepnianie spraw, przyjmowanie,odeslanie\\20181106_114224\\execution.properties')
...
not_run: CustomKeywords.'help_pack.Element_w_tabeli.Click'(findTestObject('Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_002/tabela sprawy'), 
    1, 2)
...
not_run: WebUI.click(findTestObject('Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_002/button Udostpnij'))

not_run: WebUI.setText(findTestObject('Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_002/do pola szczegoly'), 
    'test katalon przyjmij ')

not_run: WebUI.click(findTestObject('Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_002/stanowisko docelowe'))
