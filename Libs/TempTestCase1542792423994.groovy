...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy na koncie admin\\test_007 Zalozenie, zamkniecie i wznowienie sprawy\\20181121_102703\\execution.properties')
...
CustomKeywords.'help_pack.Text_from_input.Copy_text'(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_007/z pola Znak sprawy'))
...
CustomKeywords.'help_pack.Text_from_input.Paste_text'(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_007/do pola znak sprawy'))
...
CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_007/button Zamkniete'), 
    10)
...
''', 'Test Cases/Testy na koncie admin/test_007 Zalozenie, zamkniecie i wznowienie sprawy', new TestCaseBinding('Test Cases/Testy na koncie admin/test_007 Zalozenie, zamkniecie i wznowienie sprawy',[:]), FailureHandling.STOP_ON_FAILURE , false)
