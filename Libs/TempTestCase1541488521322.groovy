...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy laczone na adminie i Ludwiku\\test_last_007 Nowe zastepstwo oraz jego edycja\\20181106_081516\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_System obiegu dokumentw ESOD l/a_Powody wycof.ze skadu_menu-i'))

not_run: WebUI.click(findTestObject('Object Repository/Page_System obiegu dokumentw ESOD l/a_Wyloguj'))

not_run: WebUI.acceptAlert()

not_run: WebUI.setText(findTestObject('Object Repository/Page_System obiegu dokumentw ESOD/input_Nazwa uytkownika__userna'), 
    'admin')

not_run: WebUI.setEncryptedText(findTestObject('Object Repository/Page_System obiegu dokumentw ESOD/input_Haso__password'), 
    'gqNiyN/IiIvaUo8G1BKwoQ==')

not_run: WebUI.click(findTestObject('Object Repository/Page_System obiegu dokumentw ESOD/input_Haso_zaloguj'))
...
WebUI.click(findTestObject('Menu glowne belka gorna/przyciski glowne na belce gornej/Zastepstwa i wnioski'))

not_run: WebUI.click(findTestObject('Object Repository/Page_System obiegu dokumentw ESOD l/div_Lista'))

WebUI.click(findTestObject('Page_System obiegu dokumentw ESOD l/span_usun_powiadomienia'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Page_System obiegu dokumentw ESOD l/a_Ostatnia_test_007'), 5)

WebUI.click(findTestObject('Page_System obiegu dokumentw ESOD l/a_Ostatnia_test_007'))

WebUI.click(findTestObject('Page_System obiegu dokumentw ESOD l/td_Naczelny'))

WebUI.click(findTestObject('Page_System obiegu dokumentw ESOD l/td_Bartoszewicz_do_deaktywacji'))

WebUI.click(findTestObject('Page_System obiegu dokumentw ESOD l/div_Deaktywuj'))
