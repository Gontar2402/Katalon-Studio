...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\test_015 Dodaj, edytuj, usun blokade dokumentu przychodzacego\\20181113_083424\\execution.properties')
...
WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_004/wiersz pierwszy w Zablokowani uzytkownicy'))

WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_004/edytuj zablokowanego uzytkownika'))

WebUI.selectOptionByValue(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_004/wybierz innego uzytkownika'), 
    '8', true)

WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_004/button Zapisz'))

CustomKeywords.'help_pack.wait_for_text.not_Present'('Romanowicz', 5)
