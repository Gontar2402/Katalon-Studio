...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy na koncie admin\\test_002 usuwanie dokumentu,dodawanie dokumentu,sprawdzanie tytulu,lista nadawcow\\20181116_105740\\execution.properties')
...
not_run: WebUI.verifyTextPresent('Można usunąć jedynie ostatni dokument w rejestrze. Obecnie ostatnim dokumentem w rejestrze jest', 
...
not_run: WebUI.comment('dokument o takiej nazwie juz istnieje, sprawdza to i czeka na pokazanie bledu')
...
not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/pole pod forumlarzem aby pokaza kontrahenta '))
...
not_run: WebUI.verifyTextPresent('admin@testy.jap', false, FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/Proponowany kontrahent ktorego szukamy'))

not_run: CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe powtarzalne/button_OK2'), 
    10)

not_run: WebUI.waitForElementVisible(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/rowzin menu'), 
    10, FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/rowzin menu'))

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/Pelne odwzoraowanie cyfrowe'))

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/zapisz nowy dokument przychodzacy'))

not_run: WebUI.waitForElementNotVisible(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe powtarzalne/komunikat Prosze czekac'), 
    30)
