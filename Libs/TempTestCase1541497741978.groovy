...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy laczone na adminie i Ludwiku\\test_002 Udostepnianie spraw, przyjmowanie,odeslanie\\20181106_104901\\execution.properties')
...
WebUI.click(findTestObject('Menu glowne belka gorna/przyciski glowne na belce gornej/Sprawy'))

WebUI.click(findTestObject('Menu glowne belka gorna/podmenu Sprawy/Sprawy'))

CustomKeywords.'help_pack.Set_text_and_press_enter.set_text'(findTestObject('Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_002/do pola Tytul'), 
    'katalon_sprawa_test')
...
WebUI.click(findTestObject('Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_002/tabela sprawy', 
        [('wiersz') : 1, ('kolumna') : 2]), FailureHandling.STOP_ON_FAILURE)
