...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy jeden po drugim zastepstwa\\Test_004 Zmiana kolejnosci w schemacie akceptacji zastepstw\\20190226_120343\\execution.properties')
...
CustomKeywords.'help_pack.Logowanie.zaloguj'('radoslaw.grochowalski', 'gqNiyN/IiIvaUo8G1BKwoQ==')

AkceptacjaNaKoncieRadoslawGochowalski()
...
def ZmienKolejnoscAkceptacji() {
    ...
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//tr[@id=\\'22\\']/td[4]']), 
        15)
...
def AkceptacjaNaKoncieRadoslawGochowalski() {
