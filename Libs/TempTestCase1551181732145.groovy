...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy jeden po drugim zastepstwa\\Test_004 Zmiana kolejnosci w schemacie akceptacji zastepstw\\20190226_124847\\execution.properties')
...
def ZmienKolejnoscAkceptacji() {
    ...
    CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('button', [('xpath') : '//tr[@id=\\'60\\']/td[6]']), 
        15)

    KolejnoscLudwik = WebUI.getText(findTestObject('tabela', [('xpath') : '//tr[@id=\\'60\\']/td[6]']))
    ...
    KolejnoscLudwikaWSchemacieAkceptacji = WebUI.getText(findTestObject('tabela', [('xpath') : '//tr[@id=\\'60\\']/td[6]']))
}
...
def AkceptacjaNaKoncieDorotaBerk() {
