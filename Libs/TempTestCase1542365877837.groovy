...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy na stronie admin_php\\test_001 Nowy uzytkowni , zmiana hasla uzytkownika\\20181116_115757\\execution.properties')
...
not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/button Dodaj nowy wiersz '))

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/button Zapisz'))

not_run: CustomKeywords.'help_pack.wait_for_text.Present'('Login: Pole jest wymagane', 5)

not_run: WebUI.setText(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/do pola Login'), 
    'tadeusz.lis')
...
not_run: WebUI.setText(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/do pola E-mail'), 
    'tl@')
...
not_run: WebUI.setText(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/do pola E-mail'), 
    'katalon@email.com' + losowa_nazwa)

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/button Zapisz'))

not_run: CustomKeywords.'help_pack.Set_text_and_press_enter.na_adminie'(findTestObject('Obiekty dodatkowe na stronie testy_admin_php/Obiekty dodatkowe do test_001/do pola E-mail w wyszukiwaniu'), 
    'katalon@email.com')
