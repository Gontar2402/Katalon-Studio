...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy na koncie admin\\test_002 usuwanie dokumentu,dodawanie dokumentu,sprawdzanie tytulu,lista nadawcow\\20181116_105520\\execution.properties')
...
WebUI.comment('dokument o takiej nazwie juz istnieje, sprawdza to i czeka na pokazanie bledu')
...
WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/pole pod forumlarzem aby pokaza kontrahenta '))

WebUI.waitForElementVisible(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe do testow na adminie/Obiekty dodatkowe do test_002/Proponowany kontrahent ktorego szukamy'), 
    5)

WebUI.verifyTextPresent('admin@testy.jap', false, FailureHandling.STOP_ON_FAILURE)
