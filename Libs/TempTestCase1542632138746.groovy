...
RunConfiguration.setExecutionSettingFile('C:\\Users\\Tecra\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Testy laczone na adminie i Ludwiku\\test_005 Odeslanie dokumentu na nieaktywne stanowisko\\20181119_135538\\execution.properties')
...
not_run: CustomKeywords.'help_pack.Powtarzlna_dekretacja.dekretacja_tytul_wyszukaj'('test_4065897')
...
not_run: WebUI.navigateToUrl(GlobalVariable.Url_admin)
...
not_run: CustomKeywords.'help_pack.Set_text_and_press_enter.na_adminie'(findTestObject('Object Repository/Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/pole nazwisko'), 
    'Popielarz')

not_run: CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/wyszukany wiersz w tabeli stanowiska'), 
    10)

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/edytuj wybrany wiersz'))

not_run: WebUI.setText(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/pole wazne do'), 
    '2018-11-11')

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/button zapisz edycje wybranego wierszu'))

not_run: CustomKeywords.'help_pack.Wyloguj.wyloguj'()

not_run: CustomKeywords.'help_pack.Logowanie.zaloguj'('patrycja.podlasz', 'gqNiyN/IiIvaUo8G1BKwoQ==')

not_run: CustomKeywords.'help_pack.Powtarzlna_dekretacja.dekretacja_tytul_wyszukaj'('test_4065897')

not_run: WebUI.click(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/button Odeslij'))

not_run: CustomKeywords.'help_pack.Wait_and_click.Clickable'(findTestObject('Obiekty dodatkowe na stronie testy_hsi_pl_login/Obiekty dodatkowe w testach laczonych na adminie i ludwiku/Obiekty dodatkowe do test_005/button OK w adnotacja'), 
    10)
...
not_run: CustomKeywords.'help_pack.wait_for_text.Present'('test_4065897', 4)
